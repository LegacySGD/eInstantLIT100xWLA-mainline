...
public class LIT100xWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LIT100xWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LIT100xWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LIT100xWLAIW/InitOutcome.xml").getDocumentElement();
